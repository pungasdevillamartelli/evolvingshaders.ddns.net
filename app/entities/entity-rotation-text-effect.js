...
RotationTextEffect.prototype.render = function (gl) {	
	...
	mat4.perspective(45, gl.viewportWidth / gl.viewportHeight, 0.1, 200.0, this.pMatrix);
	...
	var vec = mat4.create();
	gl.viewport(0, 0, gl.viewportWidth, gl.viewportHeight);
	mat4.ortho(0, 5, 0, 5, 0.1, 100.0, this.pMatrix);
	mat4.identity(vec);
	mat4.translate(vec, [0.0, 0.0, -1.0]);
	//mat4.rotate(vec, this.selfRotation.z, [0.1, 0.0, 0.0]); 
