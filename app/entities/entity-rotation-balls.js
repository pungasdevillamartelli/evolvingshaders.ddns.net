...
function RotationBalls (childrenTable, radiusTable, distancesTable, valueFunction, texture) {
	...
	this.vertexShader = BallsVertexShaderSrc;
	this.fragmentShader = BallsFragmentShaderSrc;
...
RotationBalls.prototype.initialize = function (gl) {
	...
	this.initShaders(gl, this.vertexShader);
}

RotationBalls.prototype.initializeWith = function (gl, shaderProgram) {
	this.mvMatrix = mat4.create();
	this.pMatrix = mat4.create();
...
RotationBalls.prototype.initShaders = function (gl, shader) {
	...
	var source = this.fragmentShader.replace("TEXTUREFUNCTION", this.texture);
	...
	shaderProgram.levelUniform = gl.getUniformLocation(shaderProgram, "level");
...
RotationBallsNode.prototype.drawNodeSphere = function (gl, mvMatrix, pMatrix, program) {	
	var location = gl.getUniformLocation(program, "radius");
